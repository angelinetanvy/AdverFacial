...
ori_path = 'D:/Projects/FIT3161 - FYP/Main/AdverFacial/SMIC/original_learnet/'
v_path = 'D:/Projects/FIT3161 - FYP/Main/AdverFacial/SMIC/v_learnet/'
pert_path = 'D:/Projects/FIT3161 - FYP/Main/AdverFacial/SMIC/perturbed_learnet/'
...
traininglabels[0:65] = 0
traininglabels[65:116] = 1
traininglabels[116:157] = 2
...
# Learnet Model
model = Learnet_Model.build(height=64,width=64,channels=18,classes =3)
...
training_set.resize(157,64,64,18)
...
train_images, validation_images, train_labels, validation_labels =  train_test_split(training_set, traininglabels, test_size=0.8, random_state=2)
...
acc = accuracy_score(validation_labels, predictions_labels)
print(acc)

# train_images2, validation_images2, train_labels2, validation_labels2 =  train_test_split(training_set2, traininglabels, test_size=0.8, random_state=4)
# validation_labels2 = numpy.argmax(validation_labels2, axis=1)
# print(len(validation_labels2))
...
#         os.mkdir(path3)
#         for index in range (len(validation_labels2)):
...
#         val_imgs.resize(126,64,64,18)
#         predictions = model.predict(val_imgs)
#         predictions_labels = numpy.argmax(predictions, axis=1)
#         cfm = confusion_matrix(validation_labels, predictions_labels)
#         print(cfm)
#         acc = (cfm[0][0]+cfm[1][1]+cfm[2][2])/79
#         fooling_rate = 1-acc
#         print(acc)
#         iter = iter + 1
